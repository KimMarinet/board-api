...
public class FileInfoService {
    ...
    public String getFileUrl(FileInfo item) {
        return utils.getUrl(String.format("%s%s/%s/%s", request.getContextPath(), properties.getUrl(), folder(item), item.getSeq() + Objects.requireNonNullElse(item.getExtension(), "")));
    }
